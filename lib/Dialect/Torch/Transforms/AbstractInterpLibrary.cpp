...
"      torch.prim.If.yield\n"
"    }\n"
"    %3 = torch.aten.eq.int %1#1, %int10 : !torch.int, !torch.int -> !torch.bool\n"
"    %4:2 = torch.prim.If %3 -> (!torch.bool, !torch.int) {\n"
"      torch.prim.If.yield %true, %int7 : !torch.bool, !torch.int\n"
"    } else {\n"
"      %6 = torch.aten.eq.int %1#1, %int9 : !torch.int, !torch.int -> !torch.bool\n"
...
"    %int5 = torch.constant.int 5\n"
"    %0:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %1 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_complex_dtypes() : () -> !torch.list<int>\n"
"    %2 = torch.prim.ListConstruct %int5 : (!torch.int) -> !torch.list<int>\n"
"    %3 = torch.aten.add.t %1, %2 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"    %4 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_integer_dtypes() : () -> !torch.list<int>\n"
"    %5 = torch.aten.add.t %3, %4 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
...
"      torch.prim.If.yield %true : !torch.bool\n"
"    } else {\n"
"      %3 = func.call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_complex_dtypes() : () -> !torch.list<int>\n"
"      %4 = torch.prim.ListConstruct %int5 : (!torch.int) -> !torch.list<int>\n"
"      %5 = torch.aten.add.t %3, %4 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"      %6 = func.call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_integer_dtypes() : () -> !torch.list<int>\n"
"      %7 = torch.aten.add.t %5, %6 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"      %8 = torch.aten.__contains__.int_list %7, %0#1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"      %9 = torch.aten.__not__ %8 : !torch.bool -> !torch.bool\n"
"      torch.prim.If.yield %9 : !torch.bool\n"
"    }\n"
"    torch.prim.If %2 -> () {\n"
...
"    %0:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %1 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_complex_dtypes() : () -> !torch.list<int>\n"
"    %2 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_float_dtypes() : () -> !torch.list<int>\n"
"    %3 = torch.aten.add.t %1, %2 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"    %4 = torch.aten.__contains__.int_list %3, %0#1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %5 = torch.aten.__not__ %4 : !torch.bool -> !torch.bool\n"
"    torch.prim.If %5 -> () {\n"
...
"    %0:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %1 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_complex_dtypes() : () -> !torch.list<int>\n"
"    %2 = torch.prim.ListConstruct %int5, %int11 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %3 = torch.aten.add.t %1, %2 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"    %4 = torch.aten.__contains__.int_list %3, %0#1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %5 = torch.aten.__not__ %4 : !torch.bool -> !torch.bool\n"
"    torch.prim.If %5 -> () {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %6 = torch.aten.eq.int %0#1, %int11 : !torch.int, !torch.int -> !torch.bool\n"
"    %7 = torch.prim.If %6 -> (!torch.int) {\n"
...
"      %3 = torch.aten.ne.int %2#1, %int5 : !torch.int, !torch.int -> !torch.bool\n"
"      torch.prim.If %3 -> () {\n"
"        torch.prim.If.yield\n"
"      } else {\n"
"        torch.prim.RaiseException %str, %none : !torch.str, !torch.none\n"
"        torch.prim.If.yield\n"
"      }\n"
"      %4 = func.call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.is_integer_dtype(%2#1) : (!torch.int) -> !torch.bool\n"
"      %5 = torch.prim.If %4 -> (!torch.int) {\n"
"        torch.prim.If.yield %int4 : !torch.int\n"
"      } else {\n"
...
"    %5 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_complex_dtypes() : () -> !torch.list<int>\n"
"    %6 = torch.prim.ListConstruct %int5 : (!torch.int) -> !torch.list<int>\n"
"    %7 = torch.aten.add.t %5, %6 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"    %8 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_integer_dtypes() : () -> !torch.list<int>\n"
"    %9 = torch.aten.add.t %7, %8 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"    %10 = torch.aten.__contains__.int_list %9, %4 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %11 = torch.aten.__not__ %10 : !torch.bool -> !torch.bool\n"
"    torch.prim.If %11 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
...
"    %0:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %1:2 = torch.prim.TupleUnpack %arg1 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %2 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_complex_dtypes() : () -> !torch.list<int>\n"
...
"    %8 = torch.prim.ListConstruct %int5 : (!torch.int) -> !torch.list<int>\n"
"    %9 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_integer_dtypes() : () -> !torch.list<int>\n"
"    %10 = torch.aten.add.t %8, %9 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"    %11 = torch.aten.__contains__.int_list %10, %7 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %12 = torch.aten.__not__ %11 : !torch.bool -> !torch.bool\n"
"    torch.prim.If %12 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
...
"    %0:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %1 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_complex_dtypes() : () -> !torch.list<int>\n"
"    %2 = torch.prim.ListConstruct %int5, %int0, %int11 : (!torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"    %3 = torch.aten.add.t %1, %2 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"    %4 = torch.aten.__contains__.int_list %3, %0#1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %5 = torch.aten.__not__ %4 : !torch.bool -> !torch.bool\n"
"    torch.prim.If %5 -> () {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %3 = torch.aten.len.t %arg1 : !torch.list<tuple<int, int>> -> !torch.int\n"
"    torch.prim.Loop %3, %true, init() {\n"
"    ^bb0(%arg4: !torch.int):\n"
"      %4 = torch.aten.__getitem__.t %arg1, %arg4 : !torch.list<tuple<int, int>>, !torch.int -> !torch.tuple<int, int>\n"
"      %5:2 = torch.prim.TupleUnpack %4 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"      %6 = torch.prim.ListConstruct %int4, %int3, %int0, %int11 : (!torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"      %7 = torch.aten.__contains__.int_list %6, %5#1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"      torch.prim.If %7 -> () {\n"
"        torch.prim.If.yield\n"
"      } else {\n"
"        torch.prim.RaiseException %str, %none : !torch.str, !torch.none\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %3 = torch.aten.len.t %arg1 : !torch.list<optional<tuple<int, int>>> -> !torch.int\n"
"    torch.prim.Loop %3, %true, init() {\n"
"    ^bb0(%arg5: !torch.int):\n"
"      %4 = torch.aten.__getitem__.t %arg1, %arg5 : !torch.list<optional<tuple<int, int>>>, !torch.int -> !torch.optional<tuple<int, int>>\n"
"      %5 = torch.aten.__isnot__ %4, %none : !torch.optional<tuple<int, int>>, !torch.none -> !torch.bool\n"
"      torch.prim.If %5 -> () {\n"
"        %6 = torch.prim.unchecked_cast %4 : !torch.optional<tuple<int, int>> -> !torch.tuple<int, int>\n"
"        %7:2 = torch.prim.TupleUnpack %6 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"        %8 = torch.prim.ListConstruct %int4, %int3, %int0, %int11 : (!torch.int, !torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"        %9 = torch.aten.__contains__.int_list %8, %7#1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"        torch.prim.If %9 -> () {\n"
"          torch.prim.If.yield\n"
"        } else {\n"
"          torch.prim.RaiseException %str, %none : !torch.str, !torch.none\n"
...
"    torch.prim.Loop %3, %true, init() {\n"
"    ^bb0(%arg4: !torch.int):\n"
"      %4 = torch.aten.__getitem__.t %arg1, %arg4 : !torch.list<optional<tuple<int, int>>>, !torch.int -> !torch.optional<tuple<int, int>>\n"
"      %5 = torch.aten.__isnot__ %4, %none : !torch.optional<tuple<int, int>>, !torch.none -> !torch.bool\n"
"      torch.prim.If %5 -> () {\n"
"        %6 = torch.prim.unchecked_cast %4 : !torch.optional<tuple<int, int>> -> !torch.tuple<int, int>\n"
"        %7:2 = torch.prim.TupleUnpack %6 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %3 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_complex_dtypes() : () -> !torch.list<int>\n"
"    %4 = torch.prim.ListConstruct %int5 : (!torch.int) -> !torch.list<int>\n"
"    %5 = torch.aten.add.t %3, %4 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"    %6 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_integer_dtypes() : () -> !torch.list<int>\n"
"    %7 = torch.aten.add.t %5, %6 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"    %8 = torch.aten.__contains__.int_list %7, %0#1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %9 = torch.aten.__not__ %8 : !torch.bool -> !torch.bool\n"
"    torch.prim.If %9 -> () {\n"
...
"    %3 = torch.prim.ListConstruct %0#1, %1#1 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %4 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.promote_dtypes(%2, %3) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
"    %5 = torch.aten.ne.int %4, %int11 : !torch.int, !torch.int -> !torch.bool\n"
"    torch.prim.If %5 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
"      torch.prim.RaiseException %str, %none : !torch.str, !torch.none\n"
...
"    %2 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_integer_dtypes() : () -> !torch.list<int>\n"
"    %3 = torch.aten.add.t %1, %2 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"    %4 = torch.aten.__contains__.int_list %3, %0#1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %5 = torch.aten.__not__ %4 : !torch.bool -> !torch.bool\n"
"    torch.prim.If %5 -> () {\n"
...
"    %3 = torch.prim.ListConstruct %0#1, %1#1 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %4 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.promote_dtypes(%2, %3) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
"    %5 = torch.prim.ListConstruct %int5 : (!torch.int) -> !torch.list<int>\n"
"    %6 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_integer_dtypes() : () -> !torch.list<int>\n"
"    %7 = torch.aten.add.t %5, %6 : !torch.list<int>, !torch.list<int> -> !torch.list<int>\n"
"    %8 = torch.aten.__contains__.int_list %7, %4 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %9 = torch.aten.__not__ %8 : !torch.bool -> !torch.bool\n"
"    torch.prim.If %9 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
...
"    %str = torch.constant.str \"AssertionError: \"\n"
"    %0:2 = torch.prim.TupleUnpack %arg0 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %1 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.all_integer_dtypes() : () -> !torch.list<int>\n"
...
"    %4 = torch.prim.ListConstruct %0#1, %3 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %5 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.promote_dtypes(%2, %4) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
"    return %5 : !torch.int\n"
"  }\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %4 = torch.prim.ListConstruct %1#0, %0#0 : (!torch.int, !torch.int) -> !torch.list<optional<int>>\n"
"    %5 = torch.prim.ListConstruct %1#1, %0#1 : (!torch.int, !torch.int) -> !torch.list<int>\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %5 = torch.prim.ListConstruct %int5, %int11 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %6 = torch.aten.__contains__.int_list %5, %0#1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %7 = torch.aten.__not__ %6 : !torch.bool -> !torch.bool\n"
"    torch.prim.If %7 -> () {\n"
"      torch.prim.If.yield\n"
...
"    %7 = torch.prim.ListConstruct %1#1, %0#1 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %8 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.promote_dtypes(%6, %7) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
"    %9 = torch.prim.ListConstruct %int11, %int5 : (!torch.int, !torch.int) -> !torch.list<int>\n"
...
"    %1:2 = torch.prim.TupleUnpack %arg1 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %2:2 = torch.prim.TupleUnpack %arg2 : !torch.tuple<int, int> -> !torch.int, !torch.int\n"
"    %3 = torch.prim.ListConstruct %int11, %int5 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %4 = torch.aten.__contains__.int_list %3, %0#1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %5 = torch.aten.__not__ %4 : !torch.bool -> !torch.bool\n"
"    torch.prim.If %5 -> () {\n"
"      torch.prim.If.yield\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %6 = torch.prim.ListConstruct %int11, %int5 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %7 = torch.aten.__contains__.int_list %6, %1#1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %8 = torch.aten.__not__ %7 : !torch.bool -> !torch.bool\n"
"    torch.prim.If %8 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
...
"    }\n"
"    %9 = torch.prim.ListConstruct %int11, %int5 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %10 = torch.aten.__contains__.int_list %9, %2#1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %11 = torch.aten.__not__ %10 : !torch.bool -> !torch.bool\n"
"    torch.prim.If %11 -> () {\n"
"      torch.prim.If.yield\n"
"    } else {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %14 = torch.prim.ListConstruct %0#0, %1#0, %2#0 : (!torch.int, !torch.int, !torch.int) -> !torch.list<optional<int>>\n"
"    %15 = torch.prim.ListConstruct %0#1, %1#1, %2#1 : (!torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"    %16 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.promote_dtypes(%14, %15) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
"    return %16 : !torch.int\n"
"  }\n"
...
"    %8 = torch.aten.__contains__.int_list %7, %1#1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %9 = torch.aten.__not__ %8 : !torch.bool -> !torch.bool\n"
"    %10 = torch.prim.If %9 -> (!torch.bool) {\n"
...
"    }\n"
"    %11 = torch.prim.ListConstruct %int11, %int5 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %12 = torch.aten.__contains__.int_list %11, %2#1 : !torch.list<int>, !torch.int -> !torch.bool\n"
"    %13 = torch.aten.__not__ %12 : !torch.bool -> !torch.bool\n"
"    %14 = torch.prim.If %13 -> (!torch.bool) {\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %16 = torch.prim.ListConstruct %0#0, %1#0, %2#0 : (!torch.int, !torch.int, !torch.int) -> !torch.list<optional<int>>\n"
"    %17 = torch.prim.ListConstruct %0#1, %1#1, %2#1 : (!torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"    %18 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.promote_dtypes(%16, %17) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
"    return %18 : !torch.int\n"
"  }\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %17 = torch.prim.ListConstruct %0#0, %1#0, %2#0 : (!torch.int, !torch.int, !torch.int) -> !torch.list<optional<int>>\n"
"    %18 = torch.prim.ListConstruct %0#1, %1#1, %2#1 : (!torch.int, !torch.int, !torch.int) -> !torch.list<int>\n"
"    %19 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.promote_dtypes(%17, %18) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
"    return %19 : !torch.int\n"
"  }\n"
...
"      torch.prim.If.yield\n"
"    }\n"
"    %5 = torch.prim.ListConstruct %0#0, %none : (!torch.int, !torch.none) -> !torch.list<optional<int>>\n"
"    %6 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.get_dtype_of_scalar(%arg1) : (!torch.union<float, int>) -> !torch.int\n"
"    %7 = torch.prim.ListConstruct %0#1, %6 : (!torch.int, !torch.int) -> !torch.list<int>\n"
"    %8 = call @__torch__.torch_mlir.dialects.torch.importer.jit_ir.build_tools.library_generator.promote_dtypes(%5, %7) : (!torch.list<optional<int>>, !torch.list<int>) -> !torch.int\n"
"    return %8 : !torch.int\n"
"  }\n"
