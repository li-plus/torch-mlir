...
function test_in_tree() {
  ...
  python -m e2e_testing.main --config=stablehlo -v --crashing_tests_to_not_attempt_to_run_and_a_bug_is_filed ElementwiseClampModule_basic IouOfModule_basic NormalizeModule_basic
  ...
  python -m e2e_testing.main --config=torchdynamo -v --crashing_tests_to_not_attempt_to_run_and_a_bug_is_filed DropoutTrainModule_basic RandnDtypeDeviceModule_basic RandnLikeModule_basic ElementwiseClampModule_basic IouOfModule_basic NormalizeModule_basic
}
